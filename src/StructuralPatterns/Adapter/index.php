...
use PHPpatterns\StructuralPatterns\Adapter\Erps\Erp;
use PHPpatterns\StructuralPatterns\Adapter\Erps\ErpAdapter;
use PHPpatterns\StructuralPatterns\Adapter\Models\Order;
...
$order
    ...
    ->addProduct('Laptop ASUS INTEL i51084b 8GB 256 SDD')
